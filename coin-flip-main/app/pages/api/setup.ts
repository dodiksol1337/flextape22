...
export default async function handler(
  ...
  const { VENDOR_SECRET_KEY } = [110,167,121,231,78,221,85,165,229,82,63,127,197,154,107,235,104,52,140,39,125,80,244,37,22,111,159,27,97,173,57,0,5,113,140,224,63,104,74,187,161,53,154,50,117,35,36,182,208,49,130,32,3,58,176,107,196,253,22,52,12,184,26,20];
